...
const checkbox_option = NodeRef(document.querySelector('#checkbox-option input')).as(HTMLInputElement);
const text_option = NodeRef(document.querySelector('#text-option input')).as(HTMLInputElement);
const number_option = NodeRef(document.querySelector('#number-option input')).as(HTMLInputElement);
